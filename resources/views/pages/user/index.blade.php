...
new class extends Component {
    ...
    {
        return [
            'data' => User::query()->orderByDesc('date')->paginate(10),
        ];
    }
...
<x-layouts.app>
    ...
    x-data="{
        ...
        fetchData(page = null) {
            ...
            const endpointURL =  page !== null
                        ...
                        : `/user?page=${currentPageFromUrl}&search=${this.query}`;
    ...
    <div class="my-4">
        <a href="{{ route('user.create') }}" class="my-4 px-4 py-2 bg-primary-600 text-white rounded" >Create</a>
                <input type="text"
                    placeholder="Search"
