...
<x-layouts.app>
    ...
    @volt('public.image.show')
        <div class="max-w-6xl  pt-4 pb-20 mx-auto">
            <div class="w-20 mb-4">
                <x-ui.button tag="a" type="secondary"
                    href="{{ route('live-event.show', ['id' => $this?->liveEventId]) }}" class="mb-8 inline">
            ...
            <div class="flex justify-center card">
                ...
                <div
                    class=" bg-primary-700 space-x-4  border-t border-gray-200 dark:border-gray-700 dark:bg-gray-900  mb-1 text-base bg-white rounded-lg dark:bg-gray-900">
                </div>
            ...
            <div class="flex justify-end my-8 space-x-4 items-center">
                <div class=" flex space-x-2">
                    <x-ui.button tag="a" href="{{ $media->getUrl() }}" download target="_blank">
                        <div class="flex items-center space-x-1"> <span> Download </span> <svg class="w-5"
                    ...
                    <x-ui.button tag="a" href="{{ $media->getUrl() }}" target="_blank">
                        <div class="flex items-center space-x-1"> <span> Open </span>
