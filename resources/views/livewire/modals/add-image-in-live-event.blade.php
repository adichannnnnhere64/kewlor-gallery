...
$save = function () {
    ...
    $this->dispatch('idea-updated', ['liveEvent' => $liveEvent]);
};

?>

<div>
@volt('add-image-in-live-event')
...
<div class="">
    <div class="bg-white w-full p-4">
        <div class="flex items-center justify-between border-b pb-4 mb-4">
            <h2 class="text-xl font-bold">Update Idea for {{ $name }}</h2>
    ...
    <form wire:submit.prevent="save">
        ...
        @if ($this->liveEventId)
            <div wire:ignore>
                <x-ui.app.uppy :endpoint="route('upload', $this->liveEventId)">
                </x-ui.app.uppy>
            </div>
        @endif
